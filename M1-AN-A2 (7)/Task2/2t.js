let productMaster3 = [
  ...
  function updateProductMaster(purchaseDetails) {
    for (let i = 0; i < productMaster3.length; i++) {
      if (productMaster3[i].id === purchaseDetails.id) {
        productMaster3[i].quantity += purchaseDetails.purchaseQuantity;
        break;
      }
    }
  }
