let productMaster10 = [
    ...
    function incOrderQuantity(num1,num2){
        if(num1.quantity>num2.quantity)
        return 1;
         else if(num1.quantity<num2.quantity)
        return -1;
        else 
        {
            return 0;
    ...
    productMaster10.sort(incOrderQuantity);
    console.log(productMaster10);